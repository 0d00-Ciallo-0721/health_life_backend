...
class ChallengeTask(models.Model):
    ...
    task_type = models.CharField(max_length=20, default="daily", verbose_name="任务类型")
...
class Remedy(models.Model):
    ...
    points_cost = models.IntegerField(default=10, verbose_name="扣除积分")
...
class Achievement(models.Model):
    ...
    icon = models.CharField(max_length=255, blank=True, null=True, verbose_name="图标 URL")
